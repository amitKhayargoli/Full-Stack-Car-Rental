...
import car1 from "./img/Customercar3.png";
import car2 from "./img/Customercar2.png";
import car3 from "./img/Customercar1.png";
            ...
            <SwiperSlide>
              <article className="home__article car__blue">
                ...
                <div className="home__content container">
                  <div className="home__data">
                    <div className="home__titles">
                      <h3 className="home__subtitle">Your</h3>
                      <h1 className="home__title">CARS</h1>
                    </div>
                    <div className="home__image">
                  ...
                  <div className="home__info">
                    ...
                    <a className="home__button" href="/Client">
                      <span>Discover More</span>
                      <i class="ri-arrow-right-line"></i>
                    </a>
                  </div>
