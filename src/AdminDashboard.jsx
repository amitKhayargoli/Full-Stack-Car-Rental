...
import car1 from "./mini-car-01.png";
import car2 from "./mini-car-02.png";
import car3 from "./mini-car-03.png";
            ...
            <ResponsiveContainer width='210%' aspect={4 / 1}>
                <BarChart data={mileStaticsData}>
                    <XAxis dataKey='name' stroke="#2884ff"/> 
                        <Bar dataKey="Sales" stroke='#2884ff'   fill='#2884ff' barSize={40}/>
